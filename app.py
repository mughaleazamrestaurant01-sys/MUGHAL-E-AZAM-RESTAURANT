...
class Api:
    ...
    def _create_database_backup(self, directory):
        try:
            ...
            # SQLite backup API makes a consistent copy without holding a Python mutex during disk I/O.
        ...
        def execute_print():
            try:
                ...
                def wrapped(value, prefix=''):
                    """Keep every receipt field visible on its line without truncation."""
